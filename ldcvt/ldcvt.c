...
int main() {
    ...
    cvt.ndigits = 20;
    cvt.scale = 0;
    cvt.flags = F_FMT | NO_TRUNC;
    cvt.expchar = 'e';
    cvt.expwidth = 4;

    // https://github.com/open-watcom/open-watcom-v2/discussions/1160#discussioncomment-7867345

    pld.high_word = 0xfa0001a3;
    pld.low_word  = 0x6e2eb1c4;
    pld.exponent  =     0x4008;

    __LDcvt(&pld, &cvt, buf);
    printf("1000.0001 is '%s'\n", buf);
    return 0;
}
